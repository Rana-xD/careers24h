            ...
            <ul>
                    <li class="menu-item-has-children">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url("/homepage1") }}" title="">Home Layout 2</a></li>
        ...
        <div class="container">
            ...
            <div class="btn-extars">
                ...
                <div class="btns-profiles-sec">
					<span><img src="http://placehold.it/50x50" alt="" /> Tera Planer <i class="la la-angle-down"></i></span>
					<ul>
						<li><a href="/profile" title=""><i class="la la-file-text"></i>Company Profile</a></li>
						<li><a href="/manage-jobs" title=""><i class="la la-briefcase"></i>Manage Jobs</a></li>
						<li><a href="/transaction" title=""><i class="la la-money"></i>Transactions</a></li>
						<li><a href="/resume" title=""><i class="la la-paper-plane"></i>Resumes</a></li>
						<li><a href="/packages" title=""><i class="la la-user"></i>Packages</a></li>
						<li><a href="/job" title=""><i class="la la-file-text"></i>Post a New Job</a></li>
						<li><a href="/job-alert" title=""><i class="la la-flash"></i>Job Alerts</a></li>
                ...
                <div class="btns-profiles-sec">
					<span><img src="http://placehold.it/50x50" alt="" /> Tera Planer <i class="la la-angle-down"></i></span>
					<ul>
						<li><a href="/my-profile" title=""><i class="la la-file-text"></i>My Profile</a></li>
						<li><a href="/resume" title=""><i class="la la-briefcase"></i>My Resume</a></li>
						<li><a href="/shortlist" title=""><i class="la la-money"></i>Shorlisted Job</a></li>
						<li><a href="/applied-job" title=""><i class="la la-paper-plane"></i>Applied Job</a></li>
					    <li><a href="/job-notify" title=""><i class="la la-user"></i>Job Alerts</a></li>
						<li><a href="/cover-letter" title=""><i class="la la-file-text"></i>Cv & Cover Letter</a></li>
						<li><a href="/password" title=""><i class="la la-flash"></i>Change Password</a></li>
						<li><a href="/logout" title=""><i class="la la-unlink"></i>Logout</a></li>
					</ul>
				</div>
                @else
            ...
            <nav>
                <ul>
                    <li class="menu-item-has-children">
                        ...
                        <ul>
                            <li><a href="{{ url("/homepage1") }}" title="">Home Layout 1</a></li>
                            <li><a href="{{ url("/homepage2") }}" title="">Home Layout 2</a></li>
                            <li><a href="{{ url("/homepage3") }}" title="">Home Layout 3</a></li>
                            <li><a href="index4.html" title="">Home Layout 4</a></li>
                            <li><a href="index5.html" title="">Home Layout 5</a></li>
                            <li><a href="index6.html" title="">Home Layout 6</a></li>
                            <li><a href="index7.html" title="">Home Layout 7</a></li>
