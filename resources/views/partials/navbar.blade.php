            ...
            <div class="btn-extars">
                ...
                <div class="btns-profiles-sec">
					...
					<ul>
						...
						<li><a href="/company/job" title=""><i class="la la-file-text"></i>Post a New Job</a></li>
                ...
                <div class="btns-profiles-sec">
					<span><img src="http://placehold.it/50x50" alt="" /> {{  Auth::user()->username }} <i class="la la-angle-down"></i></span>
					<ul>
						<li><a href="/jobseeker/my-profile" title=""><i class="la la-file-text"></i>My Profile</a></li>
						...
						<li><a href="/jobseeker/cover-letter" title=""><i class="la la-file-text"></i>Cv & Cover Letter</a></li>
