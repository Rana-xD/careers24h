...
<div class="page-loading">
    {{-- <img src="{{ asset('style/images/loader.gif') }}" alt="" /> --}}
    ...
    <div class="responsive-menubar">
        ...
        <div class="menu-resaction">
            <div class="res-openmenu">
                <img src="{{ asset('style/images/icon.png') }}" alt="" /> Menu
            </div>
            <div class="res-closemenu">
                <img src="{{ asset('style/images/icon2.png') }}" alt="" /> Close
            </div>
        </div>
    </div>
        ...
        <div class="responsivemenu">
            <ul>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul>
                            <li><a href="{{ url('/Employees') }}" title=""> Employer List 1s</a></li>
...
<header class="gradient">
    <div class="menu-sec">
        <div class="container">
            <div class="logo">
                <a href="{{ url('/') }}" title=""><img src="http://placehold.it/178x40" alt="" /></a>
            </div><!-- Logo -->
            <div class="btn-extars">
                <a href="#" title="" class="post-job-btn"><i class="la la-plus"></i>Post Jobs</a>
                <ul class="account-btns">
            ...
            <nav>
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        <a href="#" title="">Employers</a>
                        <ul>
                            <li><a href="{{ url('/employee') }}" title=""> Employer List 1</a></li>
                            <li><a href="employer_list2.html" title="">Employer List 2</a></li>
                            <li><a href="employer_list3.html" title="">Employer List 3</a></li>
                            <li><a href="employer_list4.html" title="">Employer List 4</a></li>
                            <li><a href="employer_single1.html" title="">Employer Single 1</a></li>
