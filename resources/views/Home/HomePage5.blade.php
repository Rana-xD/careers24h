...
<div class="theme-layout" id="scrollup">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="find-cand-sec">
							<div class="iconmove"><img class="animute" src="images/resource/iconmove.jpg" alt="" /></div>
							<div class="mockup-top"><img class="animute" src="http://placehold.it/770x600" alt="" /></div>
				...
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="browse-all-cat green">
							<a href="#" title="" class="rounded">Browse All Categories</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="simple-text-block">
							...
							<a href="#" title="" class="rounded">Create an Account</a>
						</div>
					</div>
				</div>
			</div>	
	...
	<section>
		<div class="block">
			<div data-velocity="-.1" style="background: url(images/resource/parallax5.jpg) repeat scroll 50% 422.28px transparent;" class="parallax scrolly-invisible no-parallax"></div><!-- PARALLAX BACKGROUND IMAGE -->
			<div class="container">	
				<div class="row">
					<div class="col-lg-12">
						<div class="heading">
					...
					<div class="col-lg-12">
						<div class="browse-all-cat green">
							<a href="#" title="" class="rounded">Load more listings</a>
						</div>
					</div>
				</div>
			</div>
	...
	<section>
		<div class="block">
			<div data-velocity="-.3" style="background: url(images/resource/parallax6.jpg) repeat scroll 50% 422.28px transparent;" class="parallax scrolly-invisible"></div><!-- PARALLAX BACKGROUND IMAGE -->
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="heading">
	...
	<section>
		<div class="block no-padding">
			<div data-velocity="-.2" style="background: url(http://placehold.it/1920x1000) repeat scroll 50% 422.28px transparent;" class="parallax scrolly-invisible"></div><!-- PARALLAX BACKGROUND IMAGE -->
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="download-sec">
							...
							<div class="download-img">
								<img src="http://placehold.it/460x480" alt="" />
							</div>
						</div>
					</div>
				</div>
							...
							<div class="col-lg-3 column">
								<div class="widget">
									<div class="about_widget">
										<div class="logo">
											<a href="#" title=""><img src="http://placehold.it/152x25" alt="" /></a>
										</div>
...
<script src="{{ asset("/style/js/counter.js")}}" type="text/javascript"></script>
<script src="{{ asset("/style/js/mouse.js") }}" type="text/javascript"></script>
