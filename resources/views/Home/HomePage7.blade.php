		...
		<div class="topbar">
			<div class="container">
				<ul class="h-social">
					...
					<li><a href="#" title=""><i class="la la-linkedin"></i></a></li>
					<li><a href="#" title=""><i class="la la-pinterest"></i></a></li>
					<li><a href="#" title=""><i class="la la-behance"></i></a></li>
				</ul>
				<div class="h-contact">
					<span><i class="la la-phone"></i>Call us 0850 3256 98 65 </span>
					<span><i class="la la-envelope-o"></i>info@jobhunt.com </span>
				</div>
			</div>
		</div>
		<div class="menu-sec">
			<div class="container">
				<div class="logo">
					<a href="#" title=""><img src="http://placehold.it/163x31" alt="" /></a>
				</div><!-- Logo -->
				<div class="btn-extars">
					<ul class="account-btns">
									...
									<div class="search-job2 style2">	
										<form>
											<div class="row no-gape">
												...
												<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
													<div class="job-field with-icon nolbel">
														<input type="text" placeholder="Search keywords e.g. web design" />
				...
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="browse-all-cat">
							<a href="#" title="" class="style2 noradius">Browse All Categories</a>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="link_widgets3 nolines">
								<div class="row">
									<div class="col-lg-12">
										...
										<a href="#" title="">Jobs Packages </a>
										<a href="#" title="">CV Packages</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="link_widgets3 nolines">
								<div class="row">
									<div class="col-lg-12">
										...
										<a href="#" title=""><i class="la la-instagram"></i> Instagram</a>	
										<a href="#" title=""><i class="la la-pinterest"></i> Pinterest</a>	
										<a href="#" title=""><i class="la la-behance"></i> Behance</a>	
