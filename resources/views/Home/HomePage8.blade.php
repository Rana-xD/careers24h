...
<div class="theme-layout" id="scrollup">
	...
	<header class="style5">
		<div class="menu-sec">
			<div class="container fluid">
				...
				<div class="logo">
					<a href="#" title=""><img src="http://placehold.it/112x31" alt="" /></a>
				</div><!-- Logo -->
				<div class="btn-extars">
					<a href="#" title="" class="post-job-btn"><i class="la la-plus"></i>Post Jobs</a>
					<ul class="account-btns">
	...
	<section>
		<div class="block double-gap-top double-gap-bottom">
			<div data-velocity="-.1" style="background: url(http://placehold.it/1920x612) repeat scroll 50% 422.28px transparent;" class="parallax scrolly-invisible layer blackish"></div><!-- PARALLAX BACKGROUND IMAGE -->
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
	...
	<section>
		<div class="block no-padding">
			<div class="container fluid">
				<div class="row">
					<div class="col-lg-6">
						<div data-velocity="-.1" style="background: url(http://placehold.it/1920x1000) repeat scroll 50% 422.28px transparent;" class="parallax scrolly-invisible layer blackish"></div><!-- PARALLAX BACKGROUND IMAGE -->
						<div class="who-am">
				...
				<div class="row">
					...
					<div class="col-lg-4 column">
						<div class="detalbr-mkp">
							<img src="http://placehold.it/274x314" alt="" />
						</div>
					</div>
				</div>
			</div>
