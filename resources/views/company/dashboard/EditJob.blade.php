...
<script>
	jQuery(document).ready(function($){
        ...
        CAREER24H.company.loadDataForEditForm(jobType,category,qualification,careerLevel,city,description,responsibility,requiredSkill,benefit,negotiable,specificGener,gender,active);
		$(function(){
