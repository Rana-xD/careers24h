				 			...
				 			<div class="row" id="masonry_abc">
				 				<div class="col-lg-4 a">
				 					<div class="emply-text">
				 						<h3><span>A</span></h3>
				 						<ul>
				 							<li><a href="#" title="">Aoven</a></li>
				 							<li><a href="#" title="">Ab Market</a></li>
				 							<li><a href="#" title="">Altia Bank</a></li>
				 							<li><a href="#" title="">Atking Digital</a></li>
				 						</ul>
				 					</div><!-- Emply text -->
				 				</div>
				 				<div class="col-lg-4 b">
				 					<div class="emply-text">
				 						<h3><span>B</span></h3>
				 						<ul>
				 							<li><a href="#" title="">Billionay</a></li>
				 							<li><a href="#" title="">Binayo</a></li>
				 							<li><a href="#" title="">Byuonce</a></li>
				 							<li><a href="#" title="">Bina Doe</a></li>
				 							<li><a href="#" title="">Byala Juice</a></li>
				 							<li><a href="#" title="">Biasa wir</a></li>
				 							<li><a href="#" title="">Byuo Dohn</a></li>
				 						</ul>
				 					</div><!-- Emply text -->
				 				</div>
				 				<div class="col-lg-4 c">
				 					<div class="emply-text">
				 						<h3><span>C</span></h3>
				 						<ul>
				 							<li><a href="#" title="">Cilla John</a></li>
				 							<li><a href="#" title="">Cinana</a></li>
				 						</ul>
				 					</div><!-- Emply text -->
				 				</div>
				 				<div class="col-lg-4 d">
				 					<div class="emply-text">
				 						<h3><span>D</span></h3>
				 						<ul>
				 							<li><a href="#" title="">Dions</a></li>
				 							<li><a href="#" title="">Diyana Sui</a></li>
				 							<li><a href="#" title="">Dyinse Lion</a></li>
				 							<li><a href="#" title="">Diyana</a></li>
				 							<li><a href="#" title="">Dyunce</a></li>
				 							<li><a href="#" title="">Dose</a></li>
				 						</ul>
				 					</div><!-- Emply text -->
				 				</div>
				 				<div class="col-lg-4 e">
				 					<div class="emply-text">
				 						<h3><span>E</span></h3>
				 						<ul>
				 							<li><a href="#" title="">Elipa</a></li>
				 							<li><a href="#" title="">Enasa Yis</a></li>
				 							<li><a href="#" title="">Enulo</a></li>
				 							<li><a href="#" title="">Evine Doe</a></li>
				 						</ul>
				 					</div><!-- Emply text -->
				 				</div>
				 				<div class="col-lg-4 f">
				 					<div class="emply-text">
				 						<h3><span>F</span></h3>
				 						<ul>
				 							<li><a href="#" title="">Filana</a></li>
				 							<li><a href="#" title="">Fyuni</a></li>
				 							<li><a href="#" title="">Favice</a></li>
				 							<li><a href="#" title="">Flipiter</a></li>
				 							<li><a href="#" title="">Fnise</a></li>
				 						</ul>
				 					</div><!-- Emply text -->
				 				</div>
				 			</div>
...
<script src="{{ asset("/style/js/rslider.js") }}" type="text/javascript"></script>
