...
!function (a) {
  var b,
      ...
      j,
      k = {
    setNakedBarDelta: function setNakedBarDelta(a, b) {
      if ("stickToSides" === a) j = {
        toEndWidth: b,
        toBeginLeft: 0,
        toBeginWidth: b
    ...
    getSliderValuesAtPositionPx: function getSliderValuesAtPositionPx(a, b) {
      var c,
          d,
          e = this,
    ...
    validateAndMoveGripsToPx: function validateAndMoveGripsToPx(a, b) {
      var c = this,
    ...
    getGripPositionPx: function getGripPositionPx(a) {
    ...
    binarySearchValueToPxCompareFunc: function binarySearchValueToPxCompareFunc(b, c, d) {
      return b === c[d] ? 0 : b < c[d] && 0 === d ? 0 : c[d - 1] <= b && b < c[d] ? 0 : b > c[d] ? 1 : b <= c[d - 1] ? -1 : void a.error("cannot compare s: " + b + " with a[" + d + "]. a is: " + c.join(","));
    },
    binarySearch: function binarySearch(a, b, c, d) {
    ...
    set_position_from_val: function set_position_from_val(a, b) {
      var c = this,
          d = c.data("range_min"),
          e = c.data("range_max");
    ...
    set_position_from_px: function set_position_from_px(a, b) {
      var c = this;
    ...
    set_handles_at_px: function set_handles_at_px(a, b) {
      var c = this,
          d = c.data("settings"),
    ...
    drag_start_func_touch: function drag_start_func_touch(a, b, c, e, f) {
      var g = this,
          h = a.originalEvent,
          i = h.touches[0],
          j = i.pageY,
    ...
    drag_start_func: function drag_start_func(d, f, g, h, i) {
      var j = this;
      ...
      if (j.find(f.left_grip_selector + "," + f.value_bar_selector + "," + f.right_grip_selector).removeClass(f.animating_css_class), l.is_enabled.call(j)) {
        ...
        if ("object" == _typeof(f.highlight) && (n = m.is(f.highlight.panel_selector)), i !== !1 || m.is(f.left_grip_selector) || m.is(f.right_grip_selector) || m.is(f.value_bar_selector) || n || m.is(j)) {
          b = j;
          var o,
              p,
              q,
    ...
    drag_move_func_touch: function drag_move_func_touch(a) {
      if (c === !0) {
    ...
    drag_move_func: function drag_move_func(a) {
      if (c) {
        var f = b,
            g = f.data("settings"),
    ...
    drag_end_func_touch: function drag_end_func_touch(a) {
      var b = a.originalEvent;
      b.preventDefault();
      var c = b.touches[0];
      k.drag_end_func(c);
    },
    drag_end_func: function drag_end_func() {
      var a = b;
    ...
    get_rounding_for_value: function get_rounding_for_value(a) {
      var b = this,
          c = b.data("rounding"),
    ...
    notify_mouse_up_implicit: function notify_mouse_up_implicit(a) {
      var b = this,
    ...
    notify_changed_implicit: function notify_changed_implicit(a, b, c) {
      var d = this,
          e = !1;
    ...
    notify_changed_explicit: function notify_changed_explicit(a, b, c, d, e) {
      var f = this,
          g = f.data("settings");
      return f.data("aria_enabled") && k.updateAriaAttributes.call(f), g.value_changed_callback.call(f, a, d, e, b, c), f;
    },
    validate_params: function validate_params(b) {
      var c = this,
          d = c.data("range_min"),
          e = c.data("range_max"),
          f = c.data("cur_min"),
    ...
    rangemap_0_to_n: function rangemap_0_to_n(a, b) {
      var c = this,
          d = c.data("range_min"),
          e = c.data("range_max");
      return d >= a ? 0 : a >= e ? b : Math.floor((b * a - b * d) / (e - d));
    },
    inverse_rangemap_0_to_n: function inverse_rangemap_0_to_n(a, b) {
      var c = this,
          d = c.data("range_min"),
          e = c.data("range_max");
      if (0 >= a) return d;
    ...
    init: function init(b) {
      var c = a.extend({
        ...
        crossable_handles: !0,
        value_changed_callback: function value_changed_callback() {},
        user_mouseup_callback: function user_mouseup_callback() {},
        ...
        b.find(c.right_grip_selector).length > 0 && (s = !0, "undefined" == typeof r.attr("tabindex") && r.attr("tabindex", 0)), b.data("has_right_grip", s), b.data("aria_enabled") === !0 && (q.attr("role", "slider").attr("aria-disabled", "false"), s && r.attr("role", "slider").attr("aria-disabled", "false")), b.bind("keyup.nstSlider", function (a) {
          ...
          if (b.data("enabled")) {
            var c = function c(a, _c) {
              ...
              switch ("undefined" == typeof f && (g = e ? d : j, f = e ? l.get_current_min_value.call(b) : l.get_current_max_value.call(b)), _c.which) {
                case 37:
                case 40:
                  e ? d-- : j--, _c.preventDefault();
                  break;
    ...
    set_position: function set_position(a, b) {
      var c = this,
          d = c.data("cur_min"),
          e = c.data("cur_max");
    ...
    set_step_histogram: function set_step_histogram(b) {
      var c = this;
    ...
    set_range: function set_range(a, b) {
      var c = this,
    ...
    highlight_range: function highlight_range(b, c) {
      var d = this,
          e = d.data("settings");
    ...
    set_rounding: function set_rounding(b) {
      var c = this;
    ...
    round_value_according_to_rounding: function round_value_according_to_rounding(b) {
      var c = this,
    ...
    value_to_px: function value_to_px(a) {
      var b = this,
  ...
  a.fn[m] = function (b) {
    ...
    return "object" != _typeof(b) && b ? void a.error("Cannot call method " + b) : (this.data("initialized", !0), l.init.apply(this, arguments));
  };
}(jQuery);
$('.nstSlider').nstSlider({
